...
AEnemy::AEnemy()
{
	...
	CombatCollision = CreateDefaultSubobject<UBoxComponent>(TEXT("CombatColiision"));
...
void AEnemy::BeginPlay()
{
	...
	//set camera to ignore collision with mesh
...
void AEnemy::Die(AActor* Causer)
{
	...
	//set collisions off after death
	CombatCollision->SetCollisionEnabled(ECollisionEnabled::NoCollision);
	...
	//if main char is the cause of death then update main chars combat target
